...
!function($) {
    ...
    $.fn.valid_=function(object,options){
        ...
        if(myoptions !=null && validationError){
            ...
            //alert(myoptions);
            myobject.after('<span id="validerrmsg" class="help-block" style="color: #FFFFFF;">'+myoptions+'</span>');
    ...
    $.fn.valid_one=function(object,options){
