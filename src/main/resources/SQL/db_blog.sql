...
CREATE TABLE `t_blogtype` (
  ...
  `typeName` VARCHAR(30) DEFAULT NULL COMMENT '文章类别',
  `orderNum` INT(11) DEFAULT NULL COMMENT '文章排序',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_blog` (
  ...
  `summary` VARCHAR(400) DEFAULT NULL COMMENT '文章摘要',
  ...
  `type_id` INT(11) DEFAULT NULL COMMENT '外键关联文章类别',
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
...
CREATE TABLE `t_comment` (
  ...
  `blog_id` INT(11) DEFAULT NULL COMMENT '外键关联具体文章',
  PRIMARY KEY (`id`),
  KEY `blog_id` (`blog_id`),
