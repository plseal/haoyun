...
<html >
	<head>
		<meta charset="utf-8" />
		<title>儿童健康档案 三级界面 体检记录管理</title>
	...
	<body>
		<div class="container">
							...
							<!--PAGE CONTENT BEGINS-->
								...
								<tbody>
									...
									<!--
										...
										<td>2017/05/26</td>
										<td>
										<button class="btn btn-info btn-small" onclick="javascript:window.location.href='<%=request.getContextPath() %>/child_thi_health_update.jsp'">
											编辑
										</button>
		        ...
		        <div class="col-sm-12 ">
		          <button type="button" class="btn btn-lg btn-block btn-primary" onclick="location.href = '<%=request.getContextPath() %>/child_thi_health_insert.jsp';">添加新档案</button>
		        </div>
