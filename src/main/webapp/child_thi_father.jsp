    ...
    <form action="${pageContext.request.contextPath}/child_sec_main.jsp" class="form-horizontal"  role="form">
        <fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text"  class="form-control" id="child_f_name" name="child_f_name" value="司马爸爸"  placeholder="请输入姓名" check-type="required" required-message="请输入小朋友的名字">
			...
			<div class="form-group">
				 ...
				 <div class="col-sm-10 ">
					<input type="text" class="form-control" id="child_f_sex" name="child_f_sex" value="男" placeholder="" readonly  > 
				 </div>
			...
			<div class="form-group">
				 ...
				 <div class="col-sm-10 ">
	                <div class="input-group date form_date " data-date="1980/06/29" data-date-format="yyyy/mm/dd" data-link-field="dtp_input2" data-link-format="yyyy/mm/dd">
	                    <input  id="child_f_birth" class="form-control" size="16" type="text" value="" readonly >
	                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
						<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                </div>
					<input type="text" id="hid_child_f_birth" name="hid_child_f_birth" style="display:none" value="" check-type="required" required-message="请输入生日"><br/>
				 </div>
    		</div>
			...
			<div class="form-group">
				 ...
				 <div class="col-sm-10 ">
					<input type="text" class="form-control" id="child_f_age" name="child_f_age"  placeholder="" readonly  > 
				 </div>
			...
			<div class="form-group">
				 ...
				 <div class="col-sm-10 ">
					<input type="text" class="form-control" id="child_f_job" name="child_f_job" value="工程师" placeholder="请输入职业"  required-message="请输入职业">
				 </div>
			</div>
			...
			<div class="form-group">
				 ...
				 <div class="col-sm-10 ">
					<input type="text" class="form-control" id="child_f_tel" name="child_f_tel" value="13426494999" placeholder="请输入手机号" check-type="required number" required-message="请输入手机号">
				 </div>
			</div>
			<div class="form-group">
				 <label  class="col-sm-2 control-label">邮箱：</label>
				 <div class="col-sm-10 ">
					<input type="email" class="form-control" id="child_f_mail" name="child_f_mail" value="13426494999@163.com" placeholder="请输入邮箱"  check-type="email" required-message="请输入邮箱">
				 </div>
			</div>
...
$(function(){
   ...
   $("#child_f_birth").on('change',function(event){
   	   document.getElementById("hid_child_f_birth").value = $("#child_f_birth").val()
		 if ($("form").valid_one(document.getElementById("hid_child_f_birth"),"")==false){
		   return false;
		 } 
   })
	...
	$('.form_date').on('changeDate', function(ev){
	    ...
	    //if (document.getElementById("child_age").value == null) {
			...
			if (brithday != null) {
				...
				//12个月内精确到天
				if (age_of_days < 365) {
					document.getElementById("child_f_age").value = age_of_days + "天"
				//1岁以上精确到月	
				} else {
					document.getElementById("child_f_age").value = age_of_months + "月"
				}
			//clear
			} else {
				document.getElementById("child_f_age").value = ""
			}
	    //}
	});
