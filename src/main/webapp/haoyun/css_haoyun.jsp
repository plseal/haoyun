<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/haoyun/images/logo_32X32.ico" media="screen" />
<link href="${pageContext.request.contextPath}/static/css/haoyun.css?ver=1.0" rel="stylesheet" media="screen">
<link href="${pageContext.request.contextPath}/static/bootstrap3/css/buttons.css" rel="stylesheet">
